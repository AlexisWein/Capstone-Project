...
class Menu:
    def __init__(self, player, toggle_menu):
        ...
        self.sell_border = len(self.player.item_inventory) - 1     # indicates where in the list we switch from buyable to sellable items
        self.setup()
    ...
    def input(self):
        # if player presses esc, close menu
